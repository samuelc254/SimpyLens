...
# Original simpy example code from https://simpy.readthedocs.io/en/latest/examples/carwash.html (accessed 2026-03-05)
...
def model(env):
    # Create the same environment and start the setup process
    env.process(setup(env, NUM_MACHINES, WASHTIME, T_INTER))


lens = simpylens.Lens(model=model, seed=RANDOM_SEED, title="Carwash Simulation")
lens.show()
